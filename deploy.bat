...
git add index.html deploy.bat data.json data-latest.json trump-briefing.json briefing-tw-instructions.md briefing-trump-instructions.md briefing-health-instructions.md scripts\smart_pull.py scripts\update_data.py scripts\fetch_trump_news.py scripts\backfill_history.py fix_stocks.bat backfill.bat backfill_history.bat .github\workflows\update_data.yml .github\workflows\trump_news.yml
if !ERRORLEVEL! NEQ 0 (
