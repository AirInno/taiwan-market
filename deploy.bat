...
git add index.html deploy.bat data.json data-latest.json trump-briefing.json briefing-instructions.md scripts\smart_pull.py scripts\update_data.py scripts\fetch_trump_news.py fix_stocks.bat backfill.bat .github\workflows\update_data.yml .github\workflows\trump_news.yml
if !ERRORLEVEL! NEQ 0 (
