...
git add index.html deploy.bat data.json trump-briefing.json scripts\smart_pull.py scripts\update_data.py fix_stocks.bat backfill.bat .github\workflows\update_data.yml
if !ERRORLEVEL! NEQ 0 (
